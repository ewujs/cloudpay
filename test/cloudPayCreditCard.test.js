import CloudPayCreditCard from '../src/cloudPay-creditcard';
...
describe('CloudPay - Credit Card', () => {
  ...
  test('card info exists', () => {
    ...
    expect(page.cardNumberWrapper.style.display).toEqual('none');
    expect(page.cardExpirationWrapper.style.display).toEqual('none');
    expect(page.cardSecurityWrapper.style.display).toEqual('none');
